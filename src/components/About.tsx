        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-[#6c63ff] rounded-lg flex items-center justify-center mx-auto mb-4">
          ...
          >
            <div className="bg-white rounded-xl p-8 shadow-sm relative overflow-hidden">
              {/* Background effects */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#6c63ff]/30 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
              <div className="absolute top-4 right-4 w-16 h-16 bg-[#6c63ff] rounded-full opacity-20"></div>
              <div className="absolute bottom-4 left-4 w-12 h-12 bg-[#5a52e6] rounded-full opacity-30"></div>
