  ...
  return (
    <section id="roadmap" className="py-24 md:py-32 relative overflow-hidden bg-slate-900">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-r from-[#6c63ff]/5 to-[#5a52e6]/5 rounded-full opacity-50 blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-r from-[#5a52e6]/5 to-[#4c44cc]/5 rounded-full opacity-50 blur-3xl"></div>
      </div>
      ...
      <div className="container-custom relative z-10">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="text-center">
                <div className={`w-24 h-24 mx-auto mb-8 ${step.bgColor} rounded-full flex items-center justify-center text-white relative group-hover:scale-110 transition-all duration-300 shadow-lg shadow-[#6c63ff]/25`}>
                  ...
                  <div className="absolute inset-0 bg-[#6c63ff] rounded-full opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300"></div>
                </div>
                
                <div className="bg-white/10 backdrop-blur-sm border border-[#6c63ff]/20 rounded-2xl p-8 group-hover:border-[#6c63ff]/40 transition-all duration-300 group-hover:-translate-y-2 h-full">
                  <h3 className="text-xl font-bold text-[#6c63ff] mb-4 leading-tight">{step.title}</h3>
                  <p className="text-gray-300 text-base leading-relaxed">{step.description}</p>
                </div>
              </div>
              
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-10 left-full w-8 h-0.5 bg-[#6c63ff] opacity-60"></div>
              )}
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm border border-[#6c63ff]/20 rounded-2xl p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="#contact" 
                  className="inline-flex items-center px-8 py-4 bg-[#6c63ff] hover:bg-[#5a52e6] text-white font-semibold rounded-lg transition-all duration-300 shadow-lg"
                >
                  Start je project
                </a>
                <a 
                  href="#cases" 
                  className="inline-flex items-center px-8 py-4 border-2 border-[#6c63ff] text-[#6c63ff] hover:bg-[#6c63ff] hover:text-white font-semibold rounded-lg transition-all duration-300"
                >
                  Bekijk onze cases
                </a>
              </div>
